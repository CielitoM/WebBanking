...
public class PanelHistorial extends javax.swing.JPanel implements Interface_Panel{
    ...
    private void initComponents() {
        ...
        jPanelHistorial.setPreferredSize(new java.awt.Dimension(742, 400));
        ...
        jPanelHistorialLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelHistorialLayout.createSequentialGroup()
                ...
                .addGroup(jPanelHistorialLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelSaldo, javax.swing.GroupLayout.DEFAULT_SIZE, 730, Short.MAX_VALUE)
                    .addGroup(jPanelHistorialLayout.createSequentialGroup()
                        .addGroup(jPanelHistorialLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jLabelDeposito, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 362, Short.MAX_VALUE)
            ...
            .addGroup(jPanelHistorialLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanelHistorialLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabelHistorialTransacciones, javax.swing.GroupLayout.DEFAULT_SIZE, 730, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        jPanelHistorialLayout.setVerticalGroup(
            ...
            .addGroup(jPanelHistorialLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanelHistorialLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jComboBoxPagosServicios, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelPagosServicios, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(118, 118, 118)
                .addComponent(jPanelHistorial, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void mostrarInformacionCliente(Cuenta cuenta, PersistenceManager datos) {      
        ...
        // Mostrar el saldo en el jlabel de saldo del cliente
        ...
        for (Transferencia transferencia: transferencias) {
            if (transferencia.getIDCuenta().equals(cuenta.getIDCuenta()) ){              
        ...
        for (Transaccion deposito: depositos) {
            if (deposito.getIDCuenta().equals(cuenta.getIDCuenta())) {
        ...
        for (PagoTarjeta tarjeta : misTarjetas) {
            if (tarjeta.getIDCuenta().equals(cuenta.getIDCuenta())) {
        ...
        for (PagoServicios servicio : servicios) {
            if (servicio.getIDCuenta().equals(cuenta.getIDCuenta())) {
