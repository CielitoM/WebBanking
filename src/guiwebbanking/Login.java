...
/**
 * La clase Login representa la ventana de inicio de sesión en el sistema de web banking.
 * Permite a los usuarios ingresar sus credenciales y acceder a las funcionalidades del sistema.
 * Además, gestiona los intentos de inicio de sesión y mantiene la conexión con la base de datos.
 *
 * @author MAN-U
 */
public class Login extends javax.swing.JFrame {
   ...
   /**
    * Instancia de GUI para mantener actualizada la interfaz gráfica del sistema.
    */
    private GUI guiWebBanking;
    
    /**
     * Constructor predeterminado de la clase Login.
    ...
    /**
     * Constructor que instancia los atributos persistenceManager y guiWebBanking que 
     * mantienen actualizada la base de datos
     * @param persistenceManager Parámetro que contiene el persistence manager activo
     * en la sesión actual
     * @param guiWebBanking      Parámetro tipo GUI que mantiene el persistence manager activo
     */
    public void Login(PersistenceManager persistenceManager, GUI guiWebBanking){
    ...
    /**
    * Maneja la acción del botón para abrir la documentación del proyecto.
    * Este método se ejecuta cuando el usuario hace clic en el botón "Ver Documentación".
    *
    * @param evt Objeto ActionEvent que representa el evento de acción.
    *            No se utiliza directamente en este método.
    */
    private void jButtonDocumentacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDocumentacionActionPerformed
        // Crear e mostrar la ventana "Acerca del Sistema"
        VentanaAcercaDelSistema ventanaAcerca = new VentanaAcercaDelSistema();
        ventanaAcerca.setVisible(true);

        // Iniciar un hilo para la apertura de la documentación
        DocumentacionThread documentacionThread = new DocumentacionThread();
        documentacionThread.start(); 
    }//GEN-LAST:event_jButtonDocumentacionActionPerformed

    /**
     * Maneja la acción cuando se presiona la tecla "Enter" mientras el cursor está en el campo de texto de número de cuenta.
     * Este método se ejecuta cuando el usuario presiona "Enter" en el campo de texto de número de cuenta.
     *
     * @param evt Objeto ActionEvent que representa el evento de acción.
     *            No se utiliza directamente en este método.
     */
    ...
    /**
    * Maneja la acción cuando se presiona la tecla "Enter" mientras el cursor está en el campo de contraseña de la cuenta.
    * Este método se ejecuta cuando el usuario presiona "Enter" en el campo de contraseña de la cuenta.
    *
    * @param evt Objeto ActionEvent que representa el evento de acción.
    *            No se utiliza directamente en este método.
    */
    ...
    /**
     * Método invocado cuando se hace clic en el JLabel de ingresar.
     * 
     * @param evt Evento del mouse que activa el método.
     */
    private void jLabelIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelIngresarMouseClicked
        ...
        if (persistenceManager.validarInicioSesion(IDCuenta, pin) && intentosFallidos < 3) {
            ...
            ventanaPrincipal.VentanaPrincipal(IDCuenta, persistenceManager, guiWebBanking);
